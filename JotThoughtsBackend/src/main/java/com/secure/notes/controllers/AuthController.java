...
public class AuthController {
    ...
    @PostMapping(value="/public/signin",produces = "application/json")
...
//            logger.warn("User :"+loginRequest.getUsername()+",password : "+encoder.encode(loginRequest.getPassword()));
...
//      Set the authentication
    ...
    public ResponseEntity<?> forgotPassword(@RequestParam String email){
        try{
        	User user=userRepository.findByEmail(email).orElseThrow(() -> new RuntimeException("Error: User with email "+email+" is not found."));
